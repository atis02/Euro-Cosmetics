          ...
          <Stack direction="row" gap={1} alignItems="center">
            <IconButton onClick={habldeDeleteFromCart}>
              ...
              >
                ...
                ></path>{" "}
                <path stroke="#000" stroke-width="1.5" d="M12 9.598v7.8"></path>{" "}
                <path stroke="#000" stroke-width="1.5" d="M15 9.598v7.8"></path>{" "}
                <path stroke="#000" stroke-width="1.5" d="M9 9.598v7.8"></path>
              </svg>
            </IconButton>
            <Divider
              type="vertical"
